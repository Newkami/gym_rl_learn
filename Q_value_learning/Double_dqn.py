...
class DQN:
    def __init__(self, state_dim, hidden_dim, action_dim, learning_rate, gamma,
        ...
        self.optim = torch.optim.Adam(self.q_net.parameters(), lr=learning_rate)
        self.gamma = gamma
...
def train_DQN(agent: DQN, env, num_episodes, replay_buffer: ReplayBuffer, minimal_size, batch_size):
    return_list = []
    max_q_value_list = []
    max_q_value = 0
    for i in range(10):
